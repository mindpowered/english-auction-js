...
class englishauction_AuctionRepository {
	...
	Add(auction,callback) {
		...
		let args = maglev_MagLevArray.create();
		args.push(obj);
		let res = this.bus.call("Persistence.EnglishAuction.Auction.CreateNew",args);
	...
	FindById(auctionId,callback) {
		...
		let res = this.bus.call("Persistence.EnglishAuction.Auction.FindById",args);
		res.onError(function(err) {
			throw haxe_Exception.thrown(err.getMessage());
		});
		res.onResult(function(ret) {
	...
	FindAuctionsEnding(endfrom,endto,page,perpage,sort,asc,callback) {
		...
		let res = this.bus.call("Persistence.EnglishAuction.Auction.FindEnding",args);
		res.onError(function(err) {
			throw haxe_Exception.thrown(err.getMessage());
		});
		res.onResult(function(ret) {
	...
	FindAuctionsStarting(startfrom,startto,page,perpage,sort,asc,callback) {
		...
		args.push(maglev_MagLevString.fromString(sort));
		args.push(maglev_MagLevBoolean.fromBool(asc));
		let res = this.bus.call("Persistence.EnglishAuction.Auction.FindStarting",args);
		res.onError(function(err) {
			throw haxe_Exception.thrown(err.getMessage());
		});
		res.onResult(function(ret) {
	...
	FindOpenAuctions(page,perpage,sort,asc,callback) {
		...
		args.push(maglev_MagLevString.fromString(sort));
		args.push(maglev_MagLevBoolean.fromBool(asc));
		let res = this.bus.call("Persistence.EnglishAuction.Auction.FindOpen",args);
		res.onError(function(err) {
			throw haxe_Exception.thrown(err.getMessage());
		});
		res.onResult(function(ret) {
...
class englishauction_BidRepository {
	...
	Add(bid,callback) {
		...
		let args = maglev_MagLevArray.create();
		args.push(data);
		let res = this.bus.call("Persistence.EnglishAuction.Bid.New",args);
		res.onResult(function(ret) {
			callback((js_Boot.__cast(ret , maglev_MagLevString)).getString());
			return maglev_MagLevResult.fromResult(maglev_MagLevNull.create());
		});
	...
	GetNumberOfBids(auctionId,callback) {
		let args = maglev_MagLevArray.create();
		args.push(maglev_MagLevString.fromString(auctionId));
		let ret = this.bus.call("Persistence.EnglishAuction.Bid.CountForAuction",args);
		let count = 0;
		ret.onResult(function(result) {
			callback((js_Boot.__cast(result , maglev_MagLevNumber)).getInt());
			return maglev_MagLevResult.fromResult(maglev_MagLevNull.create());
		});
		ret.onError(function(error) {
			throw haxe_Exception.thrown(error.getMessage());
		});
	}
	GetHighestBids(auctionId,numBids,callback) {
		let args = maglev_MagLevArray.create();
		args.push(maglev_MagLevString.fromString(auctionId));
		args.push(maglev_MagLevNumber.fromInt(numBids));
		let res = this.bus.call("Persistence.EnglishAuction.Bid.FindByHighestPriceForAuction",args);
		res.onError(function(error) {
			throw haxe_Exception.thrown(error.getMessage());
		});
		res.onResult(function(onres) {
			let arr = js_Boot.__cast(onres , maglev_MagLevArray);
			let bids = [];
			let i = 0;
			while(i < arr.size()) {
				...
				model.price = (js_Boot.__cast(resobj.get("price") , maglev_MagLevNumber)).getFloat();
				bids.push(model);
				++i;
			}
			callback(bids);
...
class englishauction_EnglishAuction {
	...
	registerMyMethods() {
		...
		this.maglev.register("EnglishAuction.GetStart",maglev_MagLevFunction.fromFunction(function(args) {
			...
			_gthis.auctionRepo.FindById(auctionId,function(auction) {
				if(auction == null) {
					...
					let start = auction.start;
					let ret = maglev_MagLevNumber.fromFloat(start);
		...
		this.maglev.register("EnglishAuction.GetEnd",maglev_MagLevFunction.fromFunction(function(args) {
			...
			_gthis.auctionRepo.FindById(auctionId,function(auction) {
				if(auction == null) {
					...
					let end = auction.end;
					let ret = maglev_MagLevNumber.fromFloat(end);
					result.setResult(ret);
				}
			});
			return result;
		...
		this.maglev.register("EnglishAuction.HasStarted",maglev_MagLevFunction.fromFunction(function(args) {
			...
			_gthis.auctionRepo.FindById(auctionId,function(auction) {
				if(auction == null) {
					...
					let ret = maglev_MagLevBoolean.fromBool(started);
					result.setResult(ret);
				}
			});
			return result;
		...
		this.maglev.register("EnglishAuction.HasEnded",maglev_MagLevFunction.fromFunction(function(args) {
			...
			_gthis.auctionRepo.FindById(auctionId,function(auction) {
				if(auction == null) {
					...
					let now = new Date().getTime() / 1000;
					let ended = now > end;
					let ret = maglev_MagLevBoolean.fromBool(ended);
					result.setResult(ret);
				}
			});
			return result;
		...
		this.maglev.register("EnglishAuction.Bid",maglev_MagLevFunction.fromFunction(function(args) {
			...
			_gthis.bidRepo.Add(model,function(id) {
				result.setResult(maglev_MagLevString.fromString(id));
			});
			return result;
		}));
		this.maglev.register("EnglishAuction.GetHighestBidder",maglev_MagLevFunction.fromFunction(function(args) {
			let auctionId = js_Boot.__cast(args.get(0) , maglev_MagLevString);
			let myresult = maglev_MagLevResult.createAsync();
			_gthis.bidRepo.GetHighestBids(auctionId.getString(),1,function(bids) {
				if(bids.length > 0) {
					let row = bids[0];
					let myrow = maglev_MagLevObject.create();
		...
		this.maglev.register("EnglishAuction.GetHighestBids",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let myresult = maglev_MagLevResult.createAsync();
			_gthis.bidRepo.GetHighestBids(auctionId.getString(),numBids.getInt(),function(bids) {
				let rows = maglev_MagLevArray.create();
				let _g = 0;
		...
		this.maglev.register("EnglishAuction.GetNumberOfBids",maglev_MagLevFunction.fromFunction(function(args) {
			let auctionId = (js_Boot.__cast(args.get(0) , maglev_MagLevString)).getString();
			let result = maglev_MagLevResult.createAsync();
			_gthis.bidRepo.GetNumberOfBids(auctionId,function(numBids) {
		...
		this.maglev.register("EnglishAuction.CalcMinimumBid",maglev_MagLevFunction.fromFunction(function(args) {
			...
			_gthis.auctionRepo.FindById(auctionId,function(auction) {
				if(auction == null) {
					...
					let highestBid = 0;
					_gthis.bidRepo.GetHighestBids(auctionId,1,function(bids) {
						if(bids.length > 0) {
