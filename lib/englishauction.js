...
class englishauction_AuctionRepository {
	...
	FindById(auctionId) {
		...
		if(res.isError()) {
			throw haxe_Exception.thrown(res.getError().getMessage());
		}
	...
	FindAuctionsEnding(endfrom,endto,page,perpage,sort,asc) {
		let auctions = [];
		let myargs = maglev_MagLevArray.create();
		myargs.push(maglev_MagLevString.fromString("EnglishAuction.Auction"));
	...
	FindAuctionsStarting(startfrom,startto,page,perpage,sort,asc) {
		let auctions = [];
		let myargs = maglev_MagLevArray.create();
		myargs.push(maglev_MagLevString.fromString("EnglishAuction.Auction"));
	...
	FindOpenAuctions(page,perpage,sort,asc) {
		let auctions = [];
		let myargs = maglev_MagLevArray.create();
		myargs.push(maglev_MagLevString.fromString("EnglishAuction.Auction"));
...
class englishauction_EnglishAuction {
	...
	registerMyMethods() {
		...
		this.maglev.register("EnglishAuction.Create",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let end = args.get(1);
			let startingPrice = args.get(2);
			let reservePrice = args.get(3);
			let priceIncrement = args.get(4);
			...
			myarr.push(obj);
			myargs.push(myarr);
			let res = _gthis.maglev.call("Persistence.Mutate",myargs);
			return res;
		}));
		...
		this.maglev.register("EnglishAuction.GetPriceIncrement",maglev_MagLevFunction.fromFunction(function(args) {
			let auctionId = (js_Boot.__cast(args.get(0) , maglev_MagLevString)).getString();
			let auction = _gthis.auctionRepo.FindById(auctionId);
			if(auction == null) {
		...
		this.maglev.register("EnglishAuction.CalcMinimumBid",maglev_MagLevFunction.fromFunction(function(args) {
			...
			if(auction == null) {
				...
				return maglev_MagLevResult.fromResult(maglev_MagLevNumber.fromFloat(minBid));
			}
		}));
		this.maglev.register("EnglishAuction.CalcTimeRemaining",maglev_MagLevFunction.fromFunction(function(args) {
			...
			if(auction == null) {
				...
				let timeRemaining = auction.end - now;
				if(timeRemaining < 0) {
					timeRemaining = 0;
				}
		...
		this.maglev.register("EnglishAuction.GetAuctionsEnding",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let auctions = _gthis.auctionRepo.FindAuctionsEnding(endfrom,endto,page,perpage,sort,asc);
		...
		this.maglev.register("EnglishAuction.GetAuctionsStarting",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let auctions = _gthis.auctionRepo.FindAuctionsStarting(endfrom,endto,page,perpage,sort,asc);
			let results = maglev_MagLevArray.create();
			let _g = 0;
			while(_g < auctions.length) {
				let auction = auctions[_g];
		...
		this.maglev.register("EnglishAuction.GetOpenAuctions",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let auctions = _gthis.auctionRepo.FindOpenAuctions(page,perpage,sort,asc);
			let results = maglev_MagLevArray.create();
			let _g = 0;
			while(_g < auctions.length) {
				let auction = auctions[_g];
