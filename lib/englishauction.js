...
class englishauction_EnglishAuction {
	...
	registerMyMethods() {
		...
		this.maglev.register("EnglishAuction.GetMinimumBid",maglev_MagLevFunction.fromFunction(function(args) {
			let auctionId = (js_Boot.__cast(args.get(0) , maglev_MagLevString)).getString();
			let auction = _gthis.auctionRepo.FindById(auctionId);
			if(auction == null) {
				let error = maglev_MagLevError.create(0,"auction not found",maglev_MagLevNull.create());
		...
		this.maglev.register("EnglishAuction.GetTimeRemaining",maglev_MagLevFunction.fromFunction(function(args) {
			let auctionId = (js_Boot.__cast(args.get(0) , maglev_MagLevString)).getString();
		...
		this.maglev.register("EnglishAuction.GetAuctionsEnding",maglev_MagLevFunction.fromFunction(function(args) {
			...
			if(args.size() > 5) {
				asc = (js_Boot.__cast(args.get(4) , maglev_MagLevBoolean)).getBool();
			}
